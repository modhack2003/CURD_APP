  ...
  return (
    <div className="home-container" style={{backgroundImage: `url(${Image})`}}>
      ...
      <div className="button-container">
        <Link to="/signup" className="button pulse" >Create a new account</Link>
        <span className="login-link">Already have an account? <Link to='/login' className='login-home-link'>Login</Link></span>
      </div>
    </div>
  )
}
